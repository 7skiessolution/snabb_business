...
class Data {
  ...
  @override
  String toString() {
    return 'Data(name: $name, amount: $amount, note: $note, dateTime: $dateTime, type: $type, partialAmount: $partialAmount, currency: $currency, paymentType: $paymentType, imageUrl: $imageUrl, file: $file, category: $category)';
  }
