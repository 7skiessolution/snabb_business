...
class DailySaleReportPDFScreen extends StatefulWidget {
  List<DailySaleReportData>? dailysaleReportList;
  @override
  DailySaleReportPDFScreen({
    required this.dailysaleReportList,
    super.key,
  });

  @override
  State<DailySaleReportPDFScreen> createState() =>
      _DailySaleReportPDFScreenState();
}
