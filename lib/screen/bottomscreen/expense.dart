                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Center(
                          ...
                          style: TextStyle(color: expensecolor, fontSize: width * 0.035, fontWeight: FontWeight.bold),
                        )),
                      ),
                      SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: width * 0.03, color: expensecolor, fontWeight: FontWeight.bold),
                                    ),
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: width * 0.035, color: expensecolor, fontWeight: FontWeight.bold),
                                    ),
                                    Text(data.dateTime.toString().substring(0, 10),
                                        style: TextStyle(
                                          fontSize: width * 0.03,
                                        )),
                                  ],
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: data.files != null && data.files != ""
                                                ...
                                                children: [
                                                  Container(
                                                      ...
                                                      child: PinchZoomImage(
                                                        image: '${StaticValues.imageUrl}${data.files!}',
                                                      )
                                ...
                                : Text(AppLocalizations.of(context)!.nofileforthistransaction),
                          ),
                        ),
                      ),
                    ],
                  ...
                  child: Align(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        height: MediaQuery.of(context).size.height * 0.04,
                        width: MediaQuery.of(context).size.width * 0.08,
                        decoration: BoxDecoration(image: DecorationImage(image: AssetImage(data.imageUrl!)), shape: BoxShape.circle),
                      ),
                    ),
                  ),
                ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          Text(
                            "Expenses",
                            style: TextStyle(fontSize: width * 0.04, fontWeight: FontWeight.w800, color: expensecolor),
                          ),
                          SizedBox(
                              height: height * 0.2,
                              width: width,
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(fontSize: width * 0.04, fontWeight: FontWeight.bold, color: white),
                      ),
                    ),
                  ),
                  Expanded(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: width * 0.025, color: white),
                                          ),
                                          Text(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${data.category}",
                                        style: TextStyle(fontSize: width * 0.04, fontWeight: FontWeight.bold, color: expensecolor),
                                      ),
                                      SizedBox(
                                        height: height * 0.1,
                                        width: width * 0.3,
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Center(
                                                child: Text(
                                                  "${data.amount}",
                                                  style: TextStyle(fontSize: width * 0.02, fontWeight: FontWeight.bold, color: white),
                                                ),
                                              ),
                                            ),
                                            SizedBox(
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(fontSize: width * 0.02, fontWeight: FontWeight.bold, color: lightgray),
                                            )
                                          ],
                                        ),
                                      )
