                            ...
                            SizedBox(
                                ...
                                child: CircleAvatar(
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: AssetImage(widget.type == 1
                                        ? "images/sale.png"
                                        : widget.type == 0
                                            ? "images/sale.png"
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          leading:
                                                                            ...
                                                                            width:
                                                                                width * 0.12,
                                                                            decoration:
                                                                                BoxDecoration(shape: BoxShape.circle, image: DecorationImage(fit: BoxFit.cover, image: AssetImage(obj.model!.data![index].imageUrl!))),
                                                                          ),
                                                                          title:
                                                                              Text(
                                                                            obj.model!.data![index].name!,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            walletID =
                                                                                HomeController.to.walletList[index].walletId;
